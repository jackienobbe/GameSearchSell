...
/****************************************************
 * The Peg Solitaire board state class.
 * Contains necessary constructors and methods to 
 * successfully play and search for a solution to the 
 * game.
 * @author Jackie Nobbe
...
public class PegSolBoardState extends BoardState
{
	...
	/***
	 * Move peg right into an empty hole
	 * @param board 
	...
	/**
	 * Gets state of game board
	 * @return peg positions in game state
	 */
